...
<head>
    ...
    <title> Corrective Action Tools | Healtech Consultants</title>
...
<body class="bg-brown">
    ...
    <div class="title text-center text-warning">CORRECTIVE ACTION TOOLS</div>
    ...
    <div class="feature description div-lg-full text-light text-justify py-3 px-5 mb-5">
        ...
        Tools used -
        <div class="image py-4 text-center div-lgr-full">
            <img src="./images/features/action.png" alt="Corrective Action Tools">
        </div>
